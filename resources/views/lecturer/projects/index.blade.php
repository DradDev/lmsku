            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Manage real-world projects, active listings, and match with qualified student talents.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="py-6" x-data="{ tab: 'active' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 border-b border-gray-200 flex gap-4">
                <button type="button"
                        @click="tab = 'active'"
                        :class="tab === 'active' ? 'border-blue-600 text-blue-600 font-bold' : 'border-transparent text-gray-500 hover:text-gray-700 font-medium'"
                ...
                <button type="button"
                        @click="tab = 'bank'"
                        :class="tab === 'bank' ? 'border-blue-600 text-blue-600 font-bold' : 'border-transparent text-gray-500 hover:text-gray-700 font-medium'"
                        class="pb-3 px-1 border-b-2 text-sm transition-all flex items-center gap-2">
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="bg-gray-50 border-b border-gray-100">
                                    <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Judul</th>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-5 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                @php
                                                    ...
                                                    $hasNoCourse = $mainSkill && in_array($mainSkill->id, $skillsWithoutCourses ?? []);
                                                @endphp
                                                <div>
                                        ...
                                        <td class="px-5 py-4">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ route('lecturer.projects.show', $project) }}" class="inline-flex items-center px-3 py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 text-xs font-semibold rounded-xl transition">Detail</a>
                                                <a href="{{ route('lecturer.projects.edit', $project) }}" class="inline-flex items-center px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold rounded-xl transition">Edit</a>

                                                <form action="{{ route('lecturer.projects.toggle-publish', $project) }}" method="POST">
                                                    @csrf
                                                ...
                                                <form action="{{ route('lecturer.projects.destroy', $project) }}" method="POST" onsubmit="return confirm('Yakin hapus project ini?')">
                                                    @csrf
                                                    @method('DELETE')
