...
<style>
  ...
  .nav-icon {
    width: 40px; height: 40px; background: var(--blue-900);
    border-radius: 10px; display: flex; align-items: center; justify-content: center;
  }
  .nav-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 16px; font-weight: 700; color: var(--blue-900); line-height: 1.1; }
  .nav-sub   { font-size: 11px; color: var(--gray-500); }
  .btn-ghost {
    padding: 8px 18px; font-size: 14px; font-weight: 500;
    color: var(--gray-700); border-radius: 8px; text-decoration: none;
    transition: background .15s;
  }
  .btn-ghost:hover { background: var(--gray-100); }
  .btn-primary {
    padding: 9px 20px; font-size: 14px; font-weight: 600;
    color: white; background: var(--blue-700); border-radius: 8px;
  ...
  .hero {
    ...
    padding: 80px 48px 0; display: flex; flex-direction: column;
  ...
  .hero-badge-dot { width: 6px; height: 6px; background: var(--blue-400); border-radius: 50%; }
  .hero h1 {
    position: relative; font-family: 'Plus Jakarta Sans', sans-serif;
    font-size: 52px; font-weight: 800; color: white; line-height: 1.1;
    letter-spacing: -.02em; max-width: 680px; margin-bottom: 20px;
  }
  .hero h1 span { color: var(--blue-400); }
  .hero-desc {
    position: relative; font-size: 16px; color: rgba(255,255,255,.55);
    max-width: 500px; line-height: 1.7; margin-bottom: 36px;
  }
  .hero-cta { position: relative; display: flex; gap: 12px; margin-bottom: 40px; }
  .btn-hero-primary {
    padding: 13px 28px; font-size: 15px; font-weight: 600;
    color: white; background: var(--blue-600); border-radius: 10px;
    text-decoration: none; font-family: 'Plus Jakarta Sans', sans-serif;
    transition: background .15s;
  }
  .btn-hero-primary:hover { background: var(--blue-500); }
  .btn-hero-ghost {
  ...
  .hero-checklist {
    ...
    font-size: 13px; color: rgba(255,255,255,.5); margin-bottom: 56px;
  }
  ...
  .hero-strip {
    ...
    border-radius: 12px 12px 0 0; width: 100%; max-width: 780px;
    padding: 28px 24px; display: flex; justify-content: space-around;
  }
  .strip-num { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 30px; font-weight: 800; color: white; }
  .strip-label { font-size: 12px; color: rgba(255,255,255,.4); margin-top: 4px; }

  /* --- FEATURES --- */
  .features { padding: 72px 48px; background: var(--gray-50); }
  .eyebrow {
  ...
  .section-sub { font-size: 15px; color: var(--gray-500); line-height: 1.6; margin-bottom: 40px; }
  ...
  /* --- ROLES --- */
  .roles { padding: 72px 48px; background: white; border-top: 1px solid var(--gray-300); }
  ...
  .role-card {
    ...
    display: block; transition: all .2s; position: relative; overflow: hidden;
  }
  .role-card::before {
    content: ''; position: absolute; top: 0; left: 0; right: 0;
    height: 3px; background: var(--blue-700); opacity: 0; transition: opacity .2s;
  }
  .role-card:hover { border-color: var(--blue-400); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(37,99,235,.1); }
  .role-card:hover::before { opacity: 1; }
  .role-num { font-size: 11px; font-weight: 700; color: var(--gray-400); letter-spacing: .08em; text-transform: uppercase; margin-bottom: 16px; }
  .role-icon {
  ...
  .role-name {
    font-family: 'Plus Jakarta Sans', sans-serif;
    font-size: 18px; font-weight: 700; color: var(--gray-900); margin-bottom: 6px;
  }
  .role-desc { font-size: 13px; color: var(--gray-500); line-height: 1.6; }
  .role-arrow { display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; color: var(--blue-600); margin-top: 20px; }

  /* --- FOOTER --- */
  footer {
    background: var(--blue-950); padding: 28px 48px;
    display: flex; justify-content: space-between; align-items: center;
  }
  footer p { font-size: 13px; color: rgba(255,255,255,.3); }
  footer span { font-size: 13px; color: rgba(255,255,255,.2); }

  @media (max-width: 768px) {
    .navbar { padding: 0 20px; }
    .hero { padding: 60px 20px 0; }
    .hero h1 { font-size: 34px; }
    .hero-checklist { flex-direction: column; gap: 10px; }
...
<nav class="navbar">
  ...
  <div style="display:flex; align-items:center; gap:8px;">
    ...
    <a href="{{ route('register') }}" class="btn-primary">
      Mulai Sekarang
      <svg width="14" height="14" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
    </a>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-strip">
    <div style="text-align:center"><div class="strip-num">500+</div><div class="strip-label">Mahasiswa Aktif</div></div>
    <div style="text-align:center"><div class="strip-num">50+</div><div class="strip-label">Mata Kuliah</div></div>
    <div style="text-align:center"><div class="strip-num">30+</div><div class="strip-label">Dosen Pengampu</div></div>
    <div style="text-align:center"><div class="strip-num">95%</div><div class="strip-label">Tingkat Kelulusan</div></div>
  </div>
</section>
  ...
  <div class="features-grid">
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" fill="none" stroke="#1E4D96" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
      </div>
    ...
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" fill="none" stroke="#1E4D96" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
      </div>
    ...
    <div class="feature-card">
      <div class="feature-icon">
        <svg width="22" height="22" fill="none" stroke="#1E4D96" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
      </div>
...
<section class="roles">
  ...
  <div class="roles-grid">
    <a href="{{ route('login') }}" class="role-card">
      ...
      <div class="role-icon">
        <svg width="26" height="26" fill="#1E4D96" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5z"/><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg>
      </div>
      ...
      <div class="role-arrow">
        Masuk Portal
        <svg width="14" height="14" fill="none" stroke="#2563EB" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
      </div>
    </a>
    ...
    <a href="{{ route('login') }}" class="role-card">
      ...
      <div class="role-icon">
        <svg width="26" height="26" fill="none" stroke="#1E4D96" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
      </div>
    ...
    <a href="{{ route('login') }}" class="role-card">
      ...
      <div class="role-icon">
        <svg width="26" height="26" fill="none" stroke="#1E4D96" stroke-width="2" viewBox="0 0 24 24"><path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
      </div>
