        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-slate-500">
                    Perbarui nama, avatar, dan password akun Anda.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                type="email"
                                value="{{ $user->email }}"
                                class="w-full rounded-2xl border border-slate-300 bg-slate-100 px-4 py-3 text-slate-500"
                                disabled
                            >
                            <p class="mt-2 text-xs text-slate-500">
                                Email saat ini ditampilkan saja dan belum diubah dari halaman ini.
                            </p>
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700">Avatar</label>
                            <input
                                type="file"
                                name="avatar"
                ...
                <div class="space-y-6">
                    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                        <h2 class="text-xl font-semibold text-slate-900 mb-5">Profile Preview</h2>
                        ...
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="mt-1 text-sm text-slate-500">{{ ucfirst($user->role) }}</p>
                            <p class="mt-1 text-sm text-slate-500">{{ $user->email }}</p>
                        </div>
                    </div>

                    <div class="rounded-3xl border border-indigo-200 bg-indigo-50 p-6 shadow-sm">
                        <h2 class="text-xl font-semibold text-indigo-900 mb-3">Tips</h2>
