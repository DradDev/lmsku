        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="mb-8">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Rancang silabus pelatihan mandiri, kriteria passing grade sertifikat, serta target kompetensi mahasiswa.
                </p>
            </div>
            ...
            <div class="mb-8 p-5 bg-gradient-to-r from-purple-900 to-indigo-900 text-white rounded-3xl shadow-md border border-purple-800/50 space-y-2">
                ...
                <p class="text-xs text-purple-100 leading-relaxed">
                    Sebagai Author Mitra Vendor, Anda memiliki otonomi penuh atas silabus dan penentuan **Threshold Kelulusan (%)**. Mahasiswa yang lulus Kuis Akhir pada course ini akan otomatis menerima **Sertifikat Digital Verifikasi Vendor dengan Hash Blockchain & QR Code**.
                </p>
            </div>
