<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="javascript:history.back()" class="px-4 py-2 bg-slate-100 text-slate-700 font-bold text-xs rounded-xl hover:bg-slate-200 transition border border-slate-200">
                ← Kembali
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xs border border-slate-200 p-6 space-y-4">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Skill kompetensi riil mahasiswa berbasis course akademik dan sertifikasi yang telah diambil.</p>
                </div>
                    ...
                    <div class="border border-slate-200 rounded-xl p-4 bg-slate-50/50 flex flex-col justify-between space-y-3">
                        <div class="space-y-2">
                            <div class="flex items-center justify-between gap-2">
                                <h5 class="font-bold text-xs text-slate-900">{{ $skill->name }}</h5>
                                @if($hasCert)
                            ...
                            <div class="text-xs text-slate-600">
                                <span class="font-semibold text-slate-700 block mb-0.5">Course:</span>
